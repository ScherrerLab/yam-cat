...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxFramerate_2 = QtWidgets.QComboBox(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBoxFramerate_2.sizePolicy().hasHeightForWidth())
        self.comboBoxFramerate_2.setSizePolicy(sizePolicy)
        self.comboBoxFramerate_2.setObjectName("comboBoxFramerate_2")
        self.comboBoxFramerate_2.addItem("")
        self.comboBoxFramerate_2.addItem("")
        self.horizontalLayout_4.addWidget(self.comboBoxFramerate_2)
        ...
        MainWindow.setTabOrder(self.comboBoxFramerate, self.comboBoxFramerate_2)
        MainWindow.setTabOrder(self.comboBoxFramerate_2, self.lineEditParentDir)
...
"You may drag and drop items in this list so that camera names and GUIDs correspond."))
        ...
        self.comboBoxFramerate.setItemText(2, _translate("MainWindow", "30"))
        self.label_6.setText(_translate("MainWindow", "Resolution:"))
        self.comboBoxFramerate_2.setItemText(0, _translate("MainWindow", "2048x1536"))
        self.comboBoxFramerate_2.setItemText(1, _translate("MainWindow", "1920x1080"))
